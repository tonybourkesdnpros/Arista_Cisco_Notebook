...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1_Ethernet8 | routed | - | 192.168.103.31/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2_Ethernet8 | routed | - | 192.168.103.33/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3_Ethernet8 | routed | - | 192.168.103.35/31 | default | 1500 | False | - | - |
| Ethernet8 | P2P_LINK_TO_ciscoleaf2_Ethernet2 | routed | - | 192.168.109.2/31 | default | 1500 | False | - | - |
...
!
interface Ethernet8
   description P2P_LINK_TO_ciscoleaf2_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
| 192.168.109.3 | 65400 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65192
   ...
   neighbor 192.168.103.30 description spine1_Ethernet8
   neighbor 192.168.103.32 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.32 remote-as 65001
   neighbor 192.168.103.32 description spine2_Ethernet8
   neighbor 192.168.103.34 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.34 remote-as 65001
   neighbor 192.168.103.34 description spine3_Ethernet8
   neighbor 192.168.109.3 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.109.3 remote-as 65400
   neighbor 192.168.109.3 description ciscoleaf2
